	...
	<div class="sm:pt-4 sm:pb-4 pt-8 mb-8">
		...
		<div class="flex flex-col items-center justify-center px-4">
			...
			<div class="flex flex-col max-w-xl space-y-4 sm:space-y-6 md:space-y-8">
				...
				<p>My unique background as a U.S. Marine software engineer has instilled a disciplined, solutions-oriented mindset. I thrive in collaborative environments, working closely with subcontractors, project managers, and designers to deliver data-driven software solutions that align with evolving business objectives.</p>
				<p>With a proven track record in WordPress backend development, GCP API integrations, and digital agency projects, I bring a strong blend of technical expertise, problem-solving ability, and teamwork to every project. I am eager to continue creating innovative solutions that bridge technology and business needs.</p>
			</div>
		</div>		
	</div>
</template>
